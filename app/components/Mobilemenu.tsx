  ...
  return (
    <>
      <button
        ...
        className="absolute right-3 top-4 z-[200] flex h-14 w-14 items-center justify-center text-[40px] leading-none text-white transition hover:text-[#F5B74E] md:hidden"
      >
        <span
          aria-hidden="true"

...
export default function WorkStyleCarousel() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={trackRef}
        className="flex snap-x snap-mandatory gap-6 overflow-x-auto scroll-smooth px-6 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:px-10 lg:px-16"
      >
        {slides.map((slide, index) => (
          <div
            ...
            className="min-w-0 shrink-0 snap-start basis-[90%] md:basis-[76%] xl:basis-[72%] 2xl:basis-[70%]"
          >
            <div className="flex h-full min-h-[400px] flex-col rounded-[30px] border border-[#e7dcc7] bg-white p-4 shadow-[0_10px_30px_rgba(15,23,42,0.04)] sm:p-5 lg:rounded-[34px] lg:p-6">
              <div className="grid h-full grid-cols-1 gap-6 xl:grid-cols-[0.78fr_1.22fr] xl:items-stretch">
                <div className="flex h-full flex-col xl:px-2 xl:py-2">
                  <h3 className="max-w-[13ch] text-[24px] font-semibold leading-[1.08] tracking-[-0.03em] text-[#111827] md:text-[30px] lg:text-[34px]">
                    {slide.title}
                  </h3>

                  <p className="mt-4 max-w-md text-[15px] leading-[1.8] text-[#5f6b7b] md:text-[16px]">
                    {slide.text}
                  </p>
                ...
                <div className="overflow-hidden rounded-[22px] lg:rounded-[26px]">
                  <video
                    className="aspect-[16/10] h-full min-h-[240px] w-full object-cover"
                    src={slide.videoSrc}
                    poster={slide.poster}
                    muted
                    loop

          ...
          <div className="overflow-hidden">
            ...
            >
              {slides.map((slide, index) => (
                ...
                >
                  <div className="grid min-h-[430px] grid-cols-1 justify-between gap-6 rounded-[28px] bg-white p-4 text-black shadow-[0_10px_30px_rgba(15,23,42,0.04)] sm:p-6 lg:rounded-[36px] lg:p-8 xl:grid-cols-[0.9fr_1.1fr] xl:items-stretch">
                    <div className="flex flex-col xl:px-2 xl:py-2">
                      <h3 className="mb-5 max-w-[14ch] text-[28px] font-semibold leading-[1.08] tracking-[-0.03em] text-[#111827] md:text-[34px] lg:text-[42px]">
                        {slide.title}
                      </h3>

                      <p className="mb-4 max-w-md text-[16px] leading-[1.85] text-[#5f6b7b] md:text-[17px]">
                        {slide.text}
                      </p>
                    ...
                    <video
                      className="aspect-video w-full rounded-[22px] object-cover lg:rounded-[28px]"
                      src={slide.videoSrc}
                      poster={slide.poster}
                      muted
                      loop
